...
#    Poly_differ = round(self.l_poly[3] + self.r_poly[3], 2)
#    abs_curvature = abs(curvature) 
#    if abs_curvature > 0.0008 and v_ego > 25:
#      lean_offset = interp(Poly_differ, [-0.4, 0.4], [-0.8, 0.8]) #for non detect one sude lane
#      lean_offset = lean_offset * interp(abs_curvature, [0.0008, 0.01], [0.5, 1.0]) #0.5=8/4,, smooth offset
...
#    self.r_poly[3] += CAMERA_OFFSET
    ...
    speed_lane_width = interp(v_ego, [10., 31.], [2.5, 3.0])
